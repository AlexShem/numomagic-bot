...
async def get_select_date_message(dialog_manager: DialogManager, **kwargs):
    lang_messages = {
        Lang.ENG: "Choose a date to get your recommendations.",
        Lang.RUS: "Выберите дату, чтобы получить рекомендации.",
        Lang.ESP: "Elija una fecha para obtener sus recomendaciones.",
        Lang.DEU: "Wählen Sie ein Datum, um Ihre Empfehlungen zu erhalten.",
        Lang.FRA: "Choisissez une date pour obtenir vos recommandations.",
        Lang.ARA: "اختر تاريخًا للحصول على توصياتك.",
        Lang.CHI: "选择一个日期以获取您的建议。",
        Lang.HIN: "अपनी सिफारिशें प्राप्त करने के लिए एक तिथि चुनें।",
        Lang.JPN: "推奨事項を取得する日付を選択してください。"
    }
    selected_lang = dialog_manager.dialog_data.get("lang", Lang.ENG)
...
async def get_join_channel_buttons(dialog_manager: DialogManager, **kwargs):
    lang_messages = {
        ...
        Lang.RUS: {"stars": "Telegram stars", "other": "Other payment"},
        Lang.ESP: {"stars": "Telegram stars", "other": "Other payment"},
        Lang.DEU: {"stars": "Telegram stars", "other": "Other payment"},
        Lang.FRA: {"stars": "Telegram stars", "other": "Other payment"},
        Lang.ARA: {"stars": "Telegram stars", "other": "Other payment"},
        Lang.CHI: {"stars": "Telegram stars", "other": "Other payment"},
        Lang.HIN: {"stars": "Telegram stars", "other": "Other payment"},
        Lang.JPN: {"stars": "Telegram stars", "other": "Other payment"}
    }
